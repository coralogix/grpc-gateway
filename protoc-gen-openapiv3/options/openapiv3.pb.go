...
type Operation struct {
	...
	AdditionalBinding []*AdditionalBinding `protobuf:"bytes,15,rep,name=additional_binding,json=additionalBinding,proto3" json:"additional_binding,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (b0 Operation_builder) Build() *Operation {
	...
	x.AdditionalBinding = b.AdditionalBinding
	return m0
}
