...
type Operation struct {
	...
	xxx_hidden_AdditionalBinding *[]*AdditionalBinding      `protobuf:"bytes,15,rep,name=additional_binding,json=additionalBinding,proto3" json:"additional_binding,omitempty"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *Operation) GetAdditionalBinding() []*AdditionalBinding {
	if x != nil {
		if x.xxx_hidden_AdditionalBinding != nil {
			return *x.xxx_hidden_AdditionalBinding
		}
	}
	return nil
}
...
func (x *Operation) SetAdditionalBinding(v []*AdditionalBinding) {
	x.xxx_hidden_AdditionalBinding = &v
}
...
type Operation_builder struct {
	...
	// Per-binding options for the method's `additional_bindings`.
	//
	// `google.api.HttpRule` declares no extension range, so an individual
	// `additional_bindings` entry cannot carry options of its own. These entries
	// supply them from the method level instead: the Nth entry applies to the Nth
	// additional binding, in declaration order. The main binding (index 0) is
	// never addressed here -- use `google.api.method_visibility` and
	// `operation_id` for it.
	//
	// Declaring more entries than the method has additional bindings is an error.
	// Fewer is allowed; the remaining bindings keep the default behavior.
	//
	// Ignored entirely when the `ignore_additional_bindings` generator option is
	// set, since no additional binding reaches the spec in that mode. The
	// generator logs a warning in that case rather than failing.
...
func (b0 Operation_builder) Build() *Operation {
	...
	x.xxx_hidden_AdditionalBinding = &b.AdditionalBinding
	return m0
}

// Options for a single `additional_bindings` entry of a method.
type AdditionalBinding struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_NameSuffix  string                 `protobuf:"bytes,1,opt,name=name_suffix,json=nameSuffix,proto3" json:"name_suffix,omitempty"`
	xxx_hidden_Restriction string                 `protobuf:"bytes,2,opt,name=restriction,proto3" json:"restriction,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *AdditionalBinding) Reset() {
	*x = AdditionalBinding{}
...
func (x *AdditionalBinding) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdditionalBinding) ProtoMessage() {}

func (x *AdditionalBinding) ProtoReflect() protoreflect.Message {
	mi := &file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AdditionalBinding) GetNameSuffix() string {
	if x != nil {
...
func (x *AdditionalBinding) GetRestriction() string {
	if x != nil {
...
func (x *AdditionalBinding) SetNameSuffix(v string) {
	x.xxx_hidden_NameSuffix = v
}

func (x *AdditionalBinding) SetRestriction(v string) {
	x.xxx_hidden_Restriction = v
}

type AdditionalBinding_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// Appended to the generated operation ID for this binding.
	//
	// Every operation in an OpenAPI document must have a unique `operationId`,
	// but every binding of one method otherwise generates the same one. The
	// suffix is how a binding gets a name a human chose: with
	// `name_suffix: "ForCurrentTeam"`, a method `GetUser` on service
	// `UsersMgmtService` yields `UsersMgmtService_GetUserForCurrentTeam`.
	//
	// The generator owns the `<Service>_<Method>` prefix, so renaming the RPC
	// carries through without touching this field.
	//
	// When empty, the binding falls back to its one-based position --
	// `UsersMgmtService_GetUser2`, `..._GetUser3` -- matching the openapiv2
	// generator. That keeps the document valid, but the name is positional and
	...
	//
	// What does not work per binding is a "published but experimental" tier.
	// Such a tier is usually paired with a marker extension on the operation,
	// and this generator has only one `openapiv3_operation` per method: the
	// marker would land on every binding, including the published one. Marking a
	// single binding experimental needs a binding-level marker that does not
	// exist yet. Ship it hidden and publish outright instead.
	//
	// Named `restriction` rather than `visibility` to match
	// `google.api.VisibilityRule`, and so that tooling which discovers the tiers
	// in use by scanning protos for that field name finds these too. A
	// differently named field would be invisible to such a scan, and a binding
	// carrying a tier nothing else uses would then be dropped from the very
	// spec that is meant to cover every tier.
	//
	// Such scans read raw proto text, comments included, so do not write a
	// sample value next to this field name in prose -- it would be picked up as
	// a real tier.
	//
	// Empty means no restriction: the binding is always visible.
	Restriction string
}

func (b0 AdditionalBinding_builder) Build() *AdditionalBinding {
	m0 := &AdditionalBinding{}
	b, x := &b0, m0
	_, _ = b, x
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_rawDesc = []byte{
	...
	0x01, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a, 0x22, 0xc3, 0x08,
	...
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x6b, 0x0a, 0x12, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x62, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x0f, 0x20, 0x03,
	...
	0x52, 0x11, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x42, 0x69, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x1a, 0x71, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73,
	...
	0x08, 0x10, 0x09, 0x22, 0x56, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61,
	0x6c, 0x42, 0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x1f, 0x0a, 0x0b, 0x6e, 0x61, 0x6d, 0x65,
	0x5f, 0x73, 0x75, 0x66, 0x66, 0x69, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6e,
	0x61, 0x6d, 0x65, 0x53, 0x75, 0x66, 0x66, 0x69, 0x78, 0x12, 0x20, 0x0a, 0x0b, 0x72, 0x65, 0x73,
	0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x62, 0x0a, 0x0a, 0x50,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xd1, 0x01, 0x0a, 0x0d,
	...
	0x6d, 0x65, 0x12, 0x5f, 0x0a, 0x07, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70,
	0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x44, 0x69, 0x73, 0x63, 0x72, 0x69, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4d, 0x61,
	...
	0xe4, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x56, 0x0a, 0x0b, 0x6a, 0x73,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70,
	0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x4a, 0x53, 0x4f, 0x4e,
	0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x0a, 0x6a, 0x73, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x12, 0x5e, 0x0a, 0x0d, 0x64, 0x69, 0x73, 0x63, 0x72, 0x69, 0x6d, 0x69, 0x6e, 0x61,
	0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f,
	0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70,
	...
	0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0xe8, 0x03, 0x0a, 0x0a, 0x45, 0x6e, 0x75, 0x6d, 0x53,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70,
	...
	0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69,
	...
	0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65,
	0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69,
	...
	0x65, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x72, 0x65, 0x66, 0x12, 0x65, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65,
	0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x45,
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a,
	...
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xc2, 0x0b, 0x0a, 0x0a, 0x4a, 0x53, 0x4f, 0x4e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x6d, 0x75, 0x6d, 0x12, 0x1d, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x18, 0x0d,
	0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x07, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x88,
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65,
	0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x4a,
	...
	,
	...
	,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x53, 0x54, 0x52, 0x49, 0x4e, 0x47, 0x10, 0x07, 0x42, 0x0a, 0x0a, 0x08,
	0x5f, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x4a, 0x04,
	...
	0x63, 0x2d, 0x67, 0x65, 0x6e, 0x2d, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2f,
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_protoc_gen_openapiv3_options_openapiv3_proto_goTypes = []any{
	...
	(*AdditionalBinding)(nil),             // 8: grpc.gateway.protoc_gen_openapiv3.options.AdditionalBinding
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_depIdxs = []int32{
	...
	8,  // 14: grpc.gateway.protoc_gen_openapiv3.options.Operation.additional_binding:type_name -> grpc.gateway.protoc_gen_openapiv3.options.AdditionalBinding
	...
	1,  // 16: grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter.Type
	...
	2,  // 30: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.JSONSchemaSimpleTypes
	...
	39, // 36: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.security:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.SecurityEntry
	3,  // 37: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Type
	4,  // 38: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.in:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.In
	5,  // 39: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.flow:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Flow
	25, // 40: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.scopes:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Scopes
	40, // 41: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.ExtensionsEntry
	42, // 42: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.security_requirement:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementEntry
	43, // 43: grpc.gateway.protoc_gen_openapiv3.options.Scopes.scope:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Scopes.ScopeEntry
	12, // 44: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ResponsesEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response
	44, // 45: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ExtensionsEntry.value:type_name -> google.protobuf.Value
	12, // 46: grpc.gateway.protoc_gen_openapiv3.options.Operation.ResponsesEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response
	44, // 47: grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry.value:type_name -> google.protobuf.Value
	11, // 48: grpc.gateway.protoc_gen_openapiv3.options.Response.HeadersEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Header
	44, // 49: grpc.gateway.protoc_gen_openapiv3.options.Response.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 50: grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 51: grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 52: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 53: grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry.value:type_name -> google.protobuf.Value
	23, // 54: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.SecurityEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme
	44, // 55: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.ExtensionsEntry.value:type_name -> google.protobuf.Value
	41, // 56: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementValue
