...
// Stability marks the maturity of an API surface. STABLE is the zero value, so
// only experimental surfaces need annotating. Experimental operations are
// rendered with the `x-stability: experimental` extension; stable ones carry no
// marker at all.
type Stability int32

const (
	Stability_STABILITY_STABLE       Stability = 0
	Stability_STABILITY_EXPERIMENTAL Stability = 1
)
...
func (SecurityScheme_Flow) Descriptor() protoreflect.EnumDescriptor {
	return file_protoc_gen_openapiv3_options_openapiv3_proto_enumTypes[6].Descriptor()
}

func (SecurityScheme_Flow) Type() protoreflect.EnumType {
	return &file_protoc_gen_openapiv3_options_openapiv3_proto_enumTypes[6]
}
...
type Operation struct {
	...
	xxx_hidden_Stability    Stability                  `protobuf:"varint,15,opt,name=stability,proto3,enum=grpc.gateway.protoc_gen_openapiv3.options.Stability,oneof" json:"stability,omitempty"`
...
func (x *Operation) GetStability() Stability {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 13) {
			return x.xxx_hidden_Stability
		}
	}
	return Stability_STABILITY_STABLE
}
...
func (x *Operation) SetStability(v Stability) {
	x.xxx_hidden_Stability = v
...
func (x *Operation) HasStability() bool {
	if x == nil {
		return false
	}
...
func (x *Operation) ClearStability() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 13)
	x.xxx_hidden_Stability = Stability_STABILITY_STABLE
}
...
type Operation_builder struct {
	...
	// Stability of this operation. Overrides the service-level default set on
	// the `openapiv3_tag` option. Optional so an explicit STABILITY_STABLE can
	// override an experimental service.
	Stability *Stability
}
...
func (b0 Operation_builder) Build() *Operation {
	...
	if b.Stability != nil {
		...
		x.xxx_hidden_Stability = *b.Stability
	}
	return m0
}
...
type Discriminator_builder struct {
	...
	// value.
	PropertyName string
	// Mapping from payload values to the schema names or references.
...
type Schema struct {
	...
	xxx_hidden_Discriminator *Discriminator         `protobuf:"bytes,2,opt,name=discriminator,proto3" json:"discriminator,omitempty"`
...
type JSONSchema struct {
	...
	xxx_hidden_Minimum            float64                            `protobuf:"fixed64,13,opt,name=minimum,proto3,oneof" json:"minimum,omitempty"`
	...
	xxx_hidden_ValueSchema        *JSONSchema                        `protobuf:"bytes,49,opt,name=value_schema,json=valueSchema,proto3" json:"value_schema,omitempty"`
	XXX_raceDetectHookData        protoimpl.RaceDetectHookData
	XXX_presence                  [1]uint32
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
...
func (x *JSONSchema) GetValueSchema() *JSONSchema {
	if x != nil {
		return x.xxx_hidden_ValueSchema
	}
	return nil
}
...
func (x *JSONSchema) SetValueSchema(v *JSONSchema) {
	x.xxx_hidden_ValueSchema = v
}

func (x *JSONSchema) HasMinimum() bool {
	if x == nil {
		return false
	}
...
func (x *JSONSchema) HasValueSchema() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_ValueSchema != nil
}

func (x *JSONSchema) ClearMinimum() {
...
func (x *JSONSchema) ClearValueSchema() {
	x.xxx_hidden_ValueSchema = nil
}
...
type JSONSchema_builder struct {
	...
	// value of MUST be a number.
	//
	// This field is optional so annotations can intentionally set minimum: 0.
	// Non-optional proto3 scalars cannot distinguish unset from an explicit zero,
	// which would make generators drop a valid zero lower bound.
	Minimum          *float64
	...
	// See: https://swagger.io/docs/specification/2-0/swagger-extensions/
	Extensions map[string]*structpb.Value
	// Schema overrides for map value schemas. When this JSONSchema annotates a
	// map field, value_schema is merged into the generated additionalProperties
	// schema while the outer field annotation still describes the map object.
...
func (b0 JSONSchema_builder) Build() *JSONSchema {
	...
	x.xxx_hidden_Extensions = b.Extensions
	x.xxx_hidden_ValueSchema = b.ValueSchema
	return m0
}
...
type Tag struct {
	...
	xxx_hidden_Stability    Stability                  `protobuf:"varint,5,opt,name=stability,proto3,enum=grpc.gateway.protoc_gen_openapiv3.options.Stability,oneof" json:"stability,omitempty"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *Tag) GetStability() Stability {
	if x != nil {
...
func (x *Tag) SetStability(v Stability) {
	x.xxx_hidden_Stability = v
...
type Tag_builder struct {
	...
	// See: https://swagger.io/docs/specification/2-0/swagger-extensions/
	Extensions map[string]*structpb.Value
	// Default stability for every RPC in this service. Individual RPCs override
	// it via the `stability` field on their `openapiv3_operation` option.
	Stability *Stability
}
...
var file_protoc_gen_openapiv3_options_openapiv3_proto_rawDesc = []byte{
	...
	0x01, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a, 0x22, 0xbd, 0x08,
	...
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x57, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x34, 0x2e, 0x67, 0x72, 0x70, 0x63,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x48,
	0x00, 0x52, 0x09, 0x73, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x88, 0x01, 0x01, 0x1a,
	...
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x22, 0x62, 0x0a,
	0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x54, 0x0a, 0x07, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x67,
	...
	,
	...
	0x69, 0x72, 0x65, 0x64, 0x22, 0x45, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x0a, 0x07, 0x42, 0x4f, 0x4f, 0x4c, 0x45, 0x41, 0x4e, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x06, 0x10,
	0x07, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x22, 0xd8, 0x01, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64,
	...
	0x09, 0x52, 0x07, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61,
	0x74, 0x74, 0x65, 0x72, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x74,
	0x74, 0x65, 0x72, 0x6e, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06,
	...
	,
	...
	0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x12, 0x5d, 0x0a, 0x08, 0x65, 0x78, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x41, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f,
	...
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x12, 0x63, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e,
	...
	0xd6, 0x03, 0x0a, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c,
	...
	,
	...
	0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f,
	0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x2e, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x45, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x2f, 0x0a, 0x07, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x72, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xd1, 0x01,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x5f, 0x0a, 0x07, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74,
	...
	0x73, 0x2e, 0x44, 0x69, 0x73, 0x63, 0x72, 0x69, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2e,
	0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x6d, 0x61,
	0x70, 0x70, 0x69, 0x6e, 0x67, 0x1a, 0x3a, 0x0a, 0x0c, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xe4, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x56, 0x0a, 0x0b,
	...
	0x68, 0x65, 0x6d, 0x61, 0x12, 0x5e, 0x0a, 0x0d, 0x64, 0x69, 0x73, 0x63, 0x72, 0x69, 0x6d, 0x69,
	...
	0x6c, 0x65, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0xe8, 0x03, 0x0a, 0x0a, 0x45, 0x6e, 0x75,
	0x6d, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	...
	0x75, 0x6c, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x71,
	...
	0x6f, 0x63, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f,
	0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70,
	...
	0x70, 0x6c, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x66, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x72, 0x65, 0x66, 0x12, 0x65, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f,
	0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70,
	...
	0x02, 0x38, 0x01, 0x22, 0xc2, 0x0b, 0x0a, 0x0a, 0x4a, 0x53, 0x4f, 0x4e, 0x53, 0x63, 0x68, 0x65,
	...
	0x78, 0x69, 0x6d, 0x75, 0x6d, 0x12, 0x1d, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x07, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75,
	0x6d, 0x88, 0x01, 0x01, 0x12, 0x2b, 0x0a, 0x11, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x76,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x58, 0x0a, 0x0c, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x5f,
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x31, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x67,
	0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33,
	0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x4a, 0x53, 0x4f, 0x4e, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x52, 0x0b, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x10, 0x06, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x54, 0x52, 0x49, 0x4e, 0x47, 0x10, 0x07, 0x42, 0x0a,
	0x0a, 0x08, 0x5f, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02,
	...
	0x10, 0x2b, 0x4a, 0x04, 0x08, 0x2b, 0x10, 0x2e, 0x22, 0xc0, 0x03, 0x0a, 0x03, 0x54, 0x61, 0x67,
	...
	0x79, 0x52, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x57, 0x0a,
	0x09, 0x73, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x34, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61,
	0x70, 0x69, 0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x74, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x48, 0x00, 0x52, 0x09, 0x73, 0x74, 0x61, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x88, 0x01, 0x01, 0x1a, 0x55, 0x0a, 0x0f, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73,
	...
	0x0a, 0x5f, 0x73, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0xf7, 0x01, 0x0a, 0x13,
	...
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x5f, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69,
	0x76, 0x33, 0x2e, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x63, 0x6f, 0x70, 0x65,
	...
	0x03, 0x57, 0x53, 0x53, 0x10, 0x04, 0x2a, 0x3d, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x54, 0x41, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59,
	0x5f, 0x53, 0x54, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x53, 0x54, 0x41,
	0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x5f, 0x45, 0x58, 0x50, 0x45, 0x52, 0x49, 0x4d, 0x45, 0x4e,
	0x54, 0x41, 0x4c, 0x10, 0x01, 0x42, 0x48, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x33, 0x2f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var file_protoc_gen_openapiv3_options_openapiv3_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_protoc_gen_openapiv3_options_openapiv3_proto_goTypes = []any{
	...
	(Stability)(0),                        // 1: grpc.gateway.protoc_gen_openapiv3.options.Stability
	(HeaderParameter_Type)(0),             // 2: grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter.Type
	(JSONSchema_JSONSchemaSimpleTypes)(0), // 3: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.JSONSchemaSimpleTypes
	(SecurityScheme_Type)(0),              // 4: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Type
	(SecurityScheme_In)(0),                // 5: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.In
	(SecurityScheme_Flow)(0),              // 6: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Flow
	(*Swagger)(nil),                       // 7: grpc.gateway.protoc_gen_openapiv3.options.Swagger
	(*Operation)(nil),                     // 8: grpc.gateway.protoc_gen_openapiv3.options.Operation
	(*Parameters)(nil),                    // 9: grpc.gateway.protoc_gen_openapiv3.options.Parameters
	(*HeaderParameter)(nil),               // 10: grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter
	(*Header)(nil),                        // 11: grpc.gateway.protoc_gen_openapiv3.options.Header
	(*Response)(nil),                      // 12: grpc.gateway.protoc_gen_openapiv3.options.Response
	(*Info)(nil),                          // 13: grpc.gateway.protoc_gen_openapiv3.options.Info
	(*Contact)(nil),                       // 14: grpc.gateway.protoc_gen_openapiv3.options.Contact
	(*License)(nil),                       // 15: grpc.gateway.protoc_gen_openapiv3.options.License
	...
	(*JSONSchema)(nil),                    // 20: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema
	(*Tag)(nil),                           // 21: grpc.gateway.protoc_gen_openapiv3.options.Tag
	(*SecurityDefinitions)(nil),           // 22: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions
	(*SecurityScheme)(nil),                // 23: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme
	(*SecurityRequirement)(nil),           // 24: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement
	(*Scopes)(nil),                        // 25: grpc.gateway.protoc_gen_openapiv3.options.Scopes
	nil,                                   // 26: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ResponsesEntry
	nil,                                   // 27: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ExtensionsEntry
	nil,                                   // 28: grpc.gateway.protoc_gen_openapiv3.options.Operation.ResponsesEntry
	nil,                                   // 29: grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry
	nil,                                   // 30: grpc.gateway.protoc_gen_openapiv3.options.Response.HeadersEntry
	nil,                                   // 31: grpc.gateway.protoc_gen_openapiv3.options.Response.ExamplesEntry
	nil,                                   // 32: grpc.gateway.protoc_gen_openapiv3.options.Response.ExtensionsEntry
	nil,                                   // 33: grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry
	nil,                                   // 34: grpc.gateway.protoc_gen_openapiv3.options.Discriminator.MappingEntry
	nil,                                   // 35: grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.ExtensionsEntry
	(*JSONSchema_FieldConfiguration)(nil), // 36: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.FieldConfiguration
	nil,                                   // 37: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.ExtensionsEntry
	nil,                                   // 38: grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry
	nil,                                   // 39: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.SecurityEntry
	nil,                                   // 40: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.ExtensionsEntry
	(*SecurityRequirement_SecurityRequirementValue)(nil), // 41: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementValue
	nil,                    // 42: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementEntry
	nil,                    // 43: grpc.gateway.protoc_gen_openapiv3.options.Scopes.ScopeEntry
	(*structpb.Value)(nil), // 44: google.protobuf.Value
}
var file_protoc_gen_openapiv3_options_openapiv3_proto_depIdxs = []int32{
	13, // 0: grpc.gateway.protoc_gen_openapiv3.options.Swagger.info:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Info
	0,  // 1: grpc.gateway.protoc_gen_openapiv3.options.Swagger.schemes:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Scheme
	26, // 2: grpc.gateway.protoc_gen_openapiv3.options.Swagger.responses:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Swagger.ResponsesEntry
	22, // 3: grpc.gateway.protoc_gen_openapiv3.options.Swagger.security_definitions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions
	24, // 4: grpc.gateway.protoc_gen_openapiv3.options.Swagger.security:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement
	21, // 5: grpc.gateway.protoc_gen_openapiv3.options.Swagger.tags:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Tag
	16, // 6: grpc.gateway.protoc_gen_openapiv3.options.Swagger.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocumentation
	27, // 7: grpc.gateway.protoc_gen_openapiv3.options.Swagger.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Swagger.ExtensionsEntry
	16, // 8: grpc.gateway.protoc_gen_openapiv3.options.Operation.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocumentation
	28, // 9: grpc.gateway.protoc_gen_openapiv3.options.Operation.responses:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Operation.ResponsesEntry
	...
	24, // 11: grpc.gateway.protoc_gen_openapiv3.options.Operation.security:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement
	29, // 12: grpc.gateway.protoc_gen_openapiv3.options.Operation.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry
	9,  // 13: grpc.gateway.protoc_gen_openapiv3.options.Operation.parameters:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Parameters
	1,  // 14: grpc.gateway.protoc_gen_openapiv3.options.Operation.stability:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Stability
	10, // 15: grpc.gateway.protoc_gen_openapiv3.options.Parameters.headers:type_name -> grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter
	2,  // 16: grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.HeaderParameter.Type
	18, // 17: grpc.gateway.protoc_gen_openapiv3.options.Response.schema:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Schema
	30, // 18: grpc.gateway.protoc_gen_openapiv3.options.Response.headers:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response.HeadersEntry
	31, // 19: grpc.gateway.protoc_gen_openapiv3.options.Response.examples:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response.ExamplesEntry
	32, // 20: grpc.gateway.protoc_gen_openapiv3.options.Response.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response.ExtensionsEntry
	14, // 21: grpc.gateway.protoc_gen_openapiv3.options.Info.contact:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Contact
	15, // 22: grpc.gateway.protoc_gen_openapiv3.options.Info.license:type_name -> grpc.gateway.protoc_gen_openapiv3.options.License
	33, // 23: grpc.gateway.protoc_gen_openapiv3.options.Info.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry
	34, // 24: grpc.gateway.protoc_gen_openapiv3.options.Discriminator.mapping:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Discriminator.MappingEntry
	20, // 25: grpc.gateway.protoc_gen_openapiv3.options.Schema.json_schema:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema
	17, // 26: grpc.gateway.protoc_gen_openapiv3.options.Schema.discriminator:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Discriminator
	16, // 27: grpc.gateway.protoc_gen_openapiv3.options.Schema.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocumentation
	16, // 28: grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocumentation
	35, // 29: grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.ExtensionsEntry
	3,  // 30: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.JSONSchemaSimpleTypes
	36, // 31: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.field_configuration:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.FieldConfiguration
	37, // 32: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.ExtensionsEntry
	20, // 33: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.value_schema:type_name -> grpc.gateway.protoc_gen_openapiv3.options.JSONSchema
	16, // 34: grpc.gateway.protoc_gen_openapiv3.options.Tag.external_docs:type_name -> grpc.gateway.protoc_gen_openapiv3.options.ExternalDocumentation
	38, // 35: grpc.gateway.protoc_gen_openapiv3.options.Tag.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry
	1,  // 36: grpc.gateway.protoc_gen_openapiv3.options.Tag.stability:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Stability
	39, // 37: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.security:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.SecurityEntry
	4,  // 38: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.type:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Type
	5,  // 39: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.in:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.In
	6,  // 40: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.flow:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.Flow
	25, // 41: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.scopes:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Scopes
	40, // 42: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.extensions:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.ExtensionsEntry
	42, // 43: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.security_requirement:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementEntry
	43, // 44: grpc.gateway.protoc_gen_openapiv3.options.Scopes.scope:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Scopes.ScopeEntry
	12, // 45: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ResponsesEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response
	44, // 46: grpc.gateway.protoc_gen_openapiv3.options.Swagger.ExtensionsEntry.value:type_name -> google.protobuf.Value
	12, // 47: grpc.gateway.protoc_gen_openapiv3.options.Operation.ResponsesEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Response
	44, // 48: grpc.gateway.protoc_gen_openapiv3.options.Operation.ExtensionsEntry.value:type_name -> google.protobuf.Value
	11, // 49: grpc.gateway.protoc_gen_openapiv3.options.Response.HeadersEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.Header
	44, // 50: grpc.gateway.protoc_gen_openapiv3.options.Response.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 51: grpc.gateway.protoc_gen_openapiv3.options.Info.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 52: grpc.gateway.protoc_gen_openapiv3.options.EnumSchema.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 53: grpc.gateway.protoc_gen_openapiv3.options.JSONSchema.ExtensionsEntry.value:type_name -> google.protobuf.Value
	44, // 54: grpc.gateway.protoc_gen_openapiv3.options.Tag.ExtensionsEntry.value:type_name -> google.protobuf.Value
	23, // 55: grpc.gateway.protoc_gen_openapiv3.options.SecurityDefinitions.SecurityEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme
	44, // 56: grpc.gateway.protoc_gen_openapiv3.options.SecurityScheme.ExtensionsEntry.value:type_name -> google.protobuf.Value
	41, // 57: grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementEntry.value:type_name -> grpc.gateway.protoc_gen_openapiv3.options.SecurityRequirement.SecurityRequirementValue
...
func file_protoc_gen_openapiv3_options_openapiv3_proto_init() {
	...
	file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes[1].OneofWrappers = []any{}
	file_protoc_gen_openapiv3_options_openapiv3_proto_msgTypes[13].OneofWrappers = []any{}
