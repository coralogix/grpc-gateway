...
var (
	...
	defaultErrorResponseSchema     = flag.String("default_error_response_schema", "", "fully-qualified message name to use as the body schema for description-only error responses (4xx/5xx). When empty, falls back to google.rpc.Status.")
